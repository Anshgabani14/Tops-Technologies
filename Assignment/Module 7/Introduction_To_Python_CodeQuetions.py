...
with open(r"C:\Users\anshg\Downloads\Sales.csv", "r") as file:
...
with open("C:\\Users\\anshg\\Downloads\\Sales.csv", "a") as file:
    file.write("\nThis is the text that is appended to the file.")

with open("C:\\Users\\anshg\\Downloads\\Sales.csv", "r") as file:
    content = file.read()
...
file_path = "C:\\Users\\anshg\\Downloads\\Sales.csv"
